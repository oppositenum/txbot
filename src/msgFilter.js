...
// 注意："日你"/"日逼"这类单字"日"打头的脏话，去空格比对时很容易跟"生日你一定会..."
// 这种正常分享文案的"日"+"你"撞车产生假阳性(实测踩过一次坑，见下方"日你"移除记录)——
// 短小、由高频常用字组成的词条要格外小心，加新词前先想一下会不会跟常见短语拼出来。
const EXPLICIT_KW = [
  '做爱', '做哎', '抽插', '阴唇', '骚逼', '骚货', '鸡巴', '小穴', '肉穴', '浪叫',
  '光着身子', '呻吟', '高潮', '插到底', '用力插', '强吻', '咪咪头', '爱抚', '操你',
  '插入你', '脱了衣服', '打炮', '啪啪', '日逼', '爱爱', '摸吗', '射你',
  '叫爸爸', '奶大', '骚水', '开苞', '潮吹', '内射',
];
// 昵称本身就是招嫖/挑逗类信号
const SUS_NAME = [
